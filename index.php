...
<div class="sidebar-mask"></div>
      ...
      <main aria-labelledby="main-title" class="home">
        <header class="hero"><img src="hero.svg" alt="hero">
          <h1 id="main-title">
            Help Center
          </h1>
          <p class="description">
        ...
        <div class="theme-default-content custom content__default">
          ...
          <h3 id="as-easy-as-1-2-3"><a href="#as-easy-as-1-2-3" class="header-anchor">#</a> As Easy as 1, 2, 3</h3>
          <div class="features">
            <div class="feature">
              <h2>1. Create</h2>
              <p>You can create an automated(bot) or Human (Human Hybrid) chatbot. No coding or technical skills
                required</p>
            </div>
            <div class="feature">
              <h2>2. Build</h2>
              <p>Design conversations to utilise &quot;Simple&quot; or &quot;Multiple Choice&quot; or something more
                complex such as action buttons, translation, collect payments, send receipts and more. No coding or
                technical skills required</p>
            </div>
            <div class="feature">
              <h2>3. Publish</h2>
              <p>Publish your bot everywhere your users are. No coding or technical skills required</p>
            </div>
          </div>
        </div>
<?php
