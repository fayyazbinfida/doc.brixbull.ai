...
<main class="page">
        <div class="theme-default-content content__default">
          ...
          <p>In order to build your first WhatsApp chatbot, you will need the below 3 things to get started</p>
          <ul>
            <li><strong>Verified Facebook Business Manager</strong>: You will need to have a verified business manager
              account, if you don’t have it, you can still test the bot with the sandbox we offer. But the features will
              be limited.</li>
