...
<main class="page">
        <div class="theme-default-content content__default">
          ...
          <p>👋 Create your first Chatbot on the UChat platform. To begin with, have a quick look at the platform in a 2
          ...
          <ul>
            ...
            <li>How to set up your bot in each channel</li>
            <li>Integrations overview</li>
            <li>Ecommerce system overview</li>
            <li>How to upgrade your account</li>
          </ul>
        </div>
        ...
        <div class="page-nav">
          <p class="inner"><!----> <span class="next"><a href="register.html">
                Registration
              </a>
              →
            </span></p>
