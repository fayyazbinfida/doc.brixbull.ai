...
<main class="page">
        <div class="theme-default-content content__default">
          <h1 id="intercom"><a href="#intercom" class="header-anchor">#</a> Intercom</h1>
          ...
          <h2 id="key-benefits"><a href="#key-benefits" class="header-anchor">#</a> Key Benefits</h2>
          ...
          <h3 id="no-coding-knowledge-required"><a href="#no-coding-knowledge-required" class="header-anchor">#</a> No
            Coding Knowledge Required</h3>
          ...
          <h3 id="_11-channels-supported-increasing"><a href="#_11-channels-supported-increasing"
              class="header-anchor">#</a> 11+ channels supported &amp; increasing</h3>
          ...
          <h2 id="omnichannel-flow-builder"><a href="#omnichannel-flow-builder" class="header-anchor">#</a> Omnichannel
            flow builder</h2>
          <p>With our omnichannel flow builder, you can build your automation logic once, and apply it to all the social
            ...
            Viber)</p>
          <h3 id="artificial-intelligence"><a href="#artificial-intelligence" class="header-anchor">#</a> Artificial
            Intelligence</h3>
          <p>Recognize customer intent using Google Dialogflow, and redirect them to your chatbot automation. Only
            ...
            support.</p>
          <h3 id="integration-with-3rd-party"><a href="#integration-with-3rd-party" class="header-anchor">#</a>
            Integration with 3rd party</h3>
          <p>Smart ChatBot has built-in integration with Stripe, Paypal, Cloudinary, Shopify, Woocommerce, Calendly, Slack,
            ...
            management tools.</p>
          <h2 id="connect-to-intercom"><a href="#connect-to-intercom" class="header-anchor">#</a> Connect to Intercom
          </h2>
          <h3 id="step-1-connect-with-your-intercom-account"><a href="#step-1-connect-with-your-intercom-account"
              class="header-anchor">#</a> Step 1: Connect with your Intercom account</h3>
          ...
          <h2 id="use-intercom"><a href="#use-intercom" class="header-anchor">#</a> Use Intercom</h2>
          <h3 id="step-1-trigger-talk-to-human-pause-automation-anywhere-in-the-flow"><a
              href="#step-1-trigger-talk-to-human-pause-automation-anywhere-in-the-flow" class="header-anchor">#</a>
            Step 1: Trigger “Talk to Human/Pause automation” anywhere in the flow</h3>
          ...
          <h3 id="step-2-sending-files-images"><a href="#step-2-sending-files-images" class="header-anchor">#</a> Step
            2: Sending files &amp; Images</h3>
          ...
          <h3 id="step-3-ending-conversation"><a href="#step-3-ending-conversation" class="header-anchor">#</a> Step 3:
            Ending conversation</h3>
        ...
        <footer class="page-edit"><!---->
          <div class="last-updated"><span class="prefix">Last Updated:</span> <span class="time">4/28/2022, 12:01:39
              AM</span></div>
        </footer>
        <div class="page-nav">
          <p class="inner"><span class="prev">
              ←
              <a href="mark/videosdk.php" class="prev">
                VideoSdk
              </a></span> <span class="next"><a href="freshchat.php">
                Freshchat
              </a>
              →
            </span></p>
